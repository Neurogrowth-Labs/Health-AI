...
const REMEMBER_KEY = 'healthai_remember_email';
        ...
        <CardContent className="space-y-6 px-6 pb-8 pt-2 sm:px-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  disabled={isLoading}
                  className="h-12 rounded-xl border-slate-200/90 bg-sky-50/40 pl-11 pr-3.5 text-slate-900 shadow-none transition-shadow placeholder:text-slate-400 focus-visible:bg-white focus-visible:ring-sky-400/40"
                />
              </div>
            </div>
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                <label className="flex cursor-pointer items-center gap-2 text-sm text-slate-600">
                  <input
                    ...
                    className="size-4 rounded border-slate-300 text-sky-600 focus:ring-sky-500/40"
                  />
                  Remember me
                </label>
                <Link
                  href="/forgot-password"
                  className="text-sm font-medium text-sky-600 transition-colors hover:text-sky-800 hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <Button
              ...
              disabled={isLoading}
              onClick={() => {
                // Placeholder for OAuth — wire when provider is configured
              }}
            >
